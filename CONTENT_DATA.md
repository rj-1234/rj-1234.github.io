# Content Data — Use Verbatim (Do Not Invent)

This file contains all factual content for the portfolio. Use these exact values — do not hallucinate or approximate.

## Personal Info

- Name: Rajeev Joshi
- Role badge: "Principal ML Engineer · Vanguard"
- H1: "Rajeev Joshi"
- Subtitle: "Building AI infrastructure that operates at enterprise scale."
- Stats: "6+ years shipping production ML systems — 6B+ API calls/year, 99.9% uptime, 3M+ requests/day."
- Contact location: "Malvern, PA · Open to remote"
- LinkedIn: linkedin.com/in/rj1234
- GitHub: github.com/rj-1234
- CTA subtitle: "Open to principal/staff engineering roles, AI infrastructure consulting, and research collaboration."

## Publications & Awards

IEEE Paper:

- Authors: "Bansal, A., Joshi, R., et al."
- Title: "Cost-Efficient, Model-Agnostic, Low-Latency LLM Deployment"
- Venue: "IEEE AAIML 2026 — February 2026"
- Link: https://ieeexplore.ieee.org/abstract/document/11498121/

Awards:

- IT Peer Recognition Award — Vanguard IT Division (2025): "Quarterly award selected by a panel of past recipients from all IT division nominations."
- Academic Achievement Award — NYU Tandon (2018): "MS Computer Science · GPA 3.77/4.0"
- MLH HackNYU — Third Place (2018): "Built 'Feed a Homeless' — real-time platform connecting food donors with nearby homeless individuals."

Mentorship:

- Women in Data Science — Hackathon Mentor · Vanguard
- FAST Hackathon — LLM Integration Patterns · Dec 2023
- Engineer Mentorship — 1-2 engineers annually · mentee achieved promotion

## Section Headings

- Hero: (no section heading)
- Metrics: "Impact at Scale" / "Production systems processing billions of requests with enterprise-grade reliability."
- Projects: "Signature Projects" / "Enterprise AI systems built for scale, reliability, and measurable business impact."
- Skills: "Technical Depth" / "Full-stack ML engineering from model development through production serving and governance."
- Timeline: "Career Arc" / "Progressive ownership from ML pipelines to enterprise AI governance."
- Publications: "Publications & Recognition"
- Contact: "Let's build something significant."
...
## Constants Data (use as TypeScript `src/lib/constants.ts`)

The entire content below should become the constants file. It defines: METRICS, PROJECTS, TIMELINE, SKILLS, NAV_ITEMS, and TERMINAL_SNIPPETS with their TypeScript interfaces.
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    role: 'Lead Architect',
    period: '2022-Present',
    headlineMetric: '6+ teams · 100% API delivery',
    execSummary: 'Architected a unified AI SDK providing standardized access to LLM, PII redaction, and embedding services — adopted by 6+ product teams with 100% API delivery, dramatically reducing integration time.',
    ...
    impact: [
      ...
      '6+ product teams adopted the SDK',
...
export const TIMELINE: TimelineEntry[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Built Nucleus SDK adopted by 6+ product teams',
